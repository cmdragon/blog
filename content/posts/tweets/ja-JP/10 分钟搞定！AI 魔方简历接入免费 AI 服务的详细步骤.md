...
![AI プロバイダーを選択](https://cdn.game-share.store/aBClo3u1L9-mfxakQY_6H.png)
...
![API キーを取得するためにクリック](https://cdn.game-share.store/syW9LMwLw0mBa1zn4p7DI.png)

システムは新しいタブで OpenRouter 公式サイトを開きます：

![OpenRouter 公式サイト](https://cdn.game-share.store/kJmBIJzNwEna_Dqixs5Gh.png)
...
![一時メールサービス](https://cdn.game-share.store/Dn0WKPCb4GJRJzJTViZMl.png)
![アカウントを登録](https://cdn.game-share.store/zGVLipU7YiUpQ8LinfcsJ.png)
...
![設定ページ](https://cdn.game-share.store/lKVZ6Umc3EkhQRowk7O_E.png)
![API キーを管理](https://cdn.game-share.store/B6lzexbzcIwpT6oltMdNr.png)
![API キーを作成](https://cdn.game-share.store/HQT5zxuf-P6VpJmrwRAfE.png)
...
![設定情報を入力](https://cdn.game-share.store/JRme33gZtIKB8x-zxZXw-.png)
...
![無料モデルを検索](https://cdn.game-share.store/EF-1D1wvVhMMWmtGRXD93.png)

![モデル ID をコピー](https://cdn.game-share.store/NKIeBOVFdhJUfXZ-SU7j3.png)
...
![設定完了](https://cdn.game-share.store/ObI005LhshzPDb6w0qG9W.png)
![履歴書を編集](https://cdn.game-share.store/aDU_mXaziu4vj2te6KWvW.png)
![画像](https://cdn.game-share.store/RUmsRZYEV-nY4_oswvgaW.png)
![AI 機能を表示](https://cdn.game-share.store/hFDK6Na-Fi7gTL2VyMCva.png)
![生成された結果](https://cdn.game-share.store/7MEWP09NvTPOC0idG4Pz0.png)
...
![履歴書をエクスポート](https://cdn.game-share.store/XtOsWjb5TvEadMHFbtgD5.png)

**エクスポート方法**：

- **サーバーエクスポート**：サーバー上で直接 PDF ファイルを生成し、統一された形式と美しいレイアウトを保証し、ダウンロード後すぐに使用可能
  ![画像](https://cdn.game-share.store/80GzYvsfodwhT4jzExPgs.png)
- **ブラウザ印刷**：ブラウザのネイティブ印刷機能を呼び出し、プリンターに接続して直接紙のコピーを出力可能
  ![画像](https://cdn.game-share.store/v5gj00PLvRkg2Px9RKAEe.png)
...
![レート制限](https://cdn.game-share.store/N8XAuxGLIdlIRaeAjkGMN.png)
