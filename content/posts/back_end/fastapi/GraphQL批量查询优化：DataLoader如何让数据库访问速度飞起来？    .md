...
<img src="/images/9fb2368e35a1694fef2e30e6f54a72f4.jpeg" title="cmdragon_cn.png" alt="cmdragon_cn.png"/>
...
**答案**：B。DataLoader会将请求合并为`SELECT * FROM users WHERE id IN (...)`形式的批量查询，这是其核心优化机制。
...
，阅读完整的文章：[GraphQL批量查询优化：DataLoader如何让数据库访问速度飞起来？](https://blog.cmdragon.cn/posts/0e236dbe717bde52bda290e89f4f6eca/)

## 往期文章归档：

- [SQLAlchemy ORM与GraphQL的完美邂逅，如何让数据库操作变得如此简单？ - cmdragon's Blog](https://blog.cmdragon.cn/posts/9c8eddb46c54a20aae8fa1f51955a7b0/)
